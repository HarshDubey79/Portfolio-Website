...
import chatify from "../../Assets/Projects/download.jpg";
import bitsOfCode from "../../Assets/Projects/bit.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="EpicGadgetHub"
              description="An E-commerce website focused on electronics and computer accessories is a digital platform that allows customers to browse, compare, and purchase tech products such as smartphones, laptops, desktops, tablets, and accessories like keyboards, headphones, chargers, etc."
              ghLink="https://github.com/HarshDubey79"
              demoLink="https://epicgadgetshub.netlify.app/"
            />
          </Col>
